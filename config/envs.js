...
const envs = {
  ...
  // ugr: no OpenStreetMap donation message unless explicitly enabled
  ENV__ID_SHOW_DONATION_MESSAGE: JSON.stringify(process.env.ID_SHOW_DONATION_MESSAGE || 'false'),
};
